...
<script>
	function validateApplication() {
		...
		var ipReg = "^(?!0)(?!.*\.$)((1?\d?\d|25[0-5]|2[0-4]\d)(\.|$)){4}$";
		...
		if (url.match(urlReg)) {
			document.getElementById('urlError').innerHTML = "invalid URL";
			fv = false;
		}
		if (ipaddress == "") {
		...
		if (ipaddress.match(ipReg)) {
			document.getElementById('ipError').innerHTML = "invalid ip address";
			fv = false;
		}
...
<body>
	...
	<div id="container">
		<div id="container_body">
			...
			<div>
				<h2 class="form_title">Edit Application Details</h2>
		...
		<div align="center" id="contents"
			...
			<form name="appForm" action="updateApp" method="post"
