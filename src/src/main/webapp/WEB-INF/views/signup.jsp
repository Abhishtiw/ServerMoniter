			...
			<div id="container">
				<div id="container_body">
					<div align="justify">
						...
						<p class="head_para">Enter valid details to register with us</p>
					</div>
				</div>
				<!--Form  start-->
				<div align="center" id="contents"
					style="margin-left: 20px; margin-right: 20px">
					<form name="registerUser" action="registerMe" method="post"
						...
						<table style="height: 47px;" width="365">
							<tr>
								<td align="center"><button type="submit"
										...
										data-target="#myModal" onclick="return confirm('Are you sure to Register??? Please Check all the details!!!')">Register Me</button></td>
