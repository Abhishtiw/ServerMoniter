...
public class ApplicationController {
	...
	public String saveUser(@ModelAttribute("user") User user, @RequestParam("mail") String mail,
		...
		if ((userResult == true) && (mailResult == true)) {
			...
			if (request.getRequestURI().equals("saveUser")) {
	...
	public String updateUser(@ModelAttribute("user") User user, ModelMap model, @RequestParam("mailId") String mailId) {
		...
		if ((userResult == true) && (mailResult == true)) {
			...
			logger.warn("Either Update User Or Update Email Info Failed");
			throw new ServerMonitorException(ErrorCode.UPDATE_ENTITY_FAIL);
		} else {
	...
	public String getPassword(@RequestParam("emailId") String emailId, ModelMap model) {
		...
		User user = (User) appService.getEntityBasedOnEmailId(User.class, emailId);
