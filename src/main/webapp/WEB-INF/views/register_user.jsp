			...
			<form name="registerUser" action="saveUser" method="post"
				...
				<table style="height: 217px;" width="520" cellspacing="5"
					...
					<tr>
						...
						<td><span style="color: red;" id="firstNameError" class="error"> </span></td>
					</tr>
					<tr>
						<td align="center"><label>e-mail:</label></td>
						<td><input type="text" name="emailId" onkeyup="checkEmail()"
							onblur="validateUser()"></td>
						<td><span style="color: red;" id="emailError" class="error"> </span></td>
					</tr>
					<tr>
				        <td align="center"><label>Use EmailId as :</label></td>
						<td><input type="radio" id="to" name="mail" value="to" onclick="checkEmailProperty()"
							onblur="validateUser()"/> To<br>
							<input type="radio" id="cc" name="mail" value="cc" onclick="checkEmailProperty()"
							onblur="validateUser()"/> cc<br></td>
						<td><span style="color: red;" id="emailPropertyError" class="error"> </span></td>
					</tr>
					<tr>
						<td align="center"><label>Password:</label></td>
						<td><input type="password" name="password" onkeyup="checkPassword()"
							onblur="validateUser()"/></td>
							<td><span style="color: red;" id="passwordError" class="error"> </span></td>
					</tr>
