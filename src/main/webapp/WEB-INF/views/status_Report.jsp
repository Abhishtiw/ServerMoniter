				...
				<table id="tab" class="table table-hover">
					<thead style="white-space: nowrap;color: #003366;">
						<tr>
							...
							<th>Location</th>
							<th>Impact</th>
							<th align="center" style="height: 19px;
    width: 115px;">Current Status</th>
						</tr>
					</thead>
					<tbody>
							...
							<tr>
								...
								<c:choose>
									<c:when
										...
										<td align="center"><span title="ISP Up"><img alt="Up"
												src="resources/image/up.png"></span></td>
									</c:when>
									<c:otherwise>
									<td align="center"><span title="ISP Down"><img alt="Down" src="resources/image/down.png"></span></td>
								</c:otherwise>
								</c:choose>
							</tr>
						</c:forEach>
