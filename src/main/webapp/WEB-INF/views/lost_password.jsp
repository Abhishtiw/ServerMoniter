...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/checkMail.js"></script>
	...
	<div id="container">
		<div id="container_body">
			<div>
				...
				<p class="head_para">Don't worry!!! Just Type your email address. We will send the password to the provided mail id</p>
			</div>
	</div>
	...
	<div align="center" id="contents"
		...
		<form name="registerUser" action="get_password" method="post"
			...
			<table style="height: 47px;" width="365">
				<tr>
					<td align="center"><button type="submit" class="btn btn-info btn-sm"
