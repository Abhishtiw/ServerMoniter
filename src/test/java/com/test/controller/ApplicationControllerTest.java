 ...
 * 
 * Mockito just mocks the actual Object or actual interface and create a
 * scenario of we are working with actual objects., but actually speaking, we
 * are working with mock objects or dummy objects to test the application.
 * 
 * @author nkumar
 *
 */
...
public class ApplicationControllerTest {
	...
	/*
	 * @Before indicates that this method must be executed before each test in
	 * the class, so as to execute some preconditions necessary for the test.
	 */
	@Before
	public void setUp() {
		// initMocks() is a static method of MockitoAnnotations which
		// initializes the mocking
		MockitoAnnotations.initMocks(this);
		// standaloneSetup(mock object).build() builds the application to be
		// test is standalone application while testing.
	...
	/*
	 * @Test tells JUnit that the public void method to which it is attached can
	...
	public void testGetEntityList() throws Exception {
		...
		/*
		 * here notice that 'when' and 'then' are static methods provided by
		 * Mockito framework when(method calls).thenReturn(something) is the
		 * logic behind it.
		 */
		when(applicationService.getEntityList(Application.class)).thenReturn(applications);
		/*
		 * when we perform /displayAction and we are expecting the status of
		 * application as Ok and we expect the view as display_app.
		 */
		mockMvc.perform(get("/displayApplication")).andExpect(status().isOk()).andExpect(view().name("display_app"));
		/*
		 * by using assertEquals static method we are asserting the
		 * functionality of the method.so that we can test the method execution
		 */
	...
	/*
	 * this method test the whether the application object is fetched based on
	 * id or not.
	 */
	@Test
	public void testGetEntityById() {
		...
		/*
		 * when we call getEntityById then the method should return application
		 * object based on id
		 */
		when(applicationService.getEntityByID(Application.class, 1001)).thenReturn(application1);
		/*
		 * again using assertEquals() we are asserting whether the outcome is
		 * correct or not.
		 */
	...
	public void testUpdateEntity() throws Exception {
		...
		/*
		 * when we call updateEntity then the method if it updates it should
		 * return true
		 */
	...
	/*
	 * this method test the functionality of adding a new entity(whether it may
	 * be application or other, but it should extends entity).
	 */
	@Test
	public void testAddEntity() throws Exception {

		application3.setId(1003);
		...
		/*
		 * when we call addEntity then the method if it adds it should return
		 * true
		 */
	...
	/*
	 * this method test the functionality of deleting the existed entity(whether
	 * it may be application or other, but it should extends entity).
	 */
	@Test
	public void testDeleteEntity() {
		...
		/*
		 * when we call deleteEntity then the method if it deletes it should
		 * return true
		 */
